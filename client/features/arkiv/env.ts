...
/** Which IVF set we ask Arkiv for. Defaults to the v2 corpus
 * (`ivf-v2`, N=96760, C=2048, turboquant-wasm chunk embeddings).
 * Override with NEXT_PUBLIC_CENTROID_SET_ID. */
export const CENTROID_SET_ID =
  process.env.NEXT_PUBLIC_CENTROID_SET_ID ?? "ivf-v2";
